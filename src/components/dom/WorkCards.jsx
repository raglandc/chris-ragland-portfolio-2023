...
function CardPopUp({ title, link, image, description, closeHandler, skills }) {
  return (
    <PortalOverlay className='absolute top-0 left-0 z-30 flex justify-center w-screen h-full overflow-y-scroll from-black/95 bg-gradient-to-b to-slate-900 text-slate-100'>
